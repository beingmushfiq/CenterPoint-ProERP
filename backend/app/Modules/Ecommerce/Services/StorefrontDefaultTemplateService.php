...
class StorefrontDefaultTemplateService
{
    /**
    ...
    public function seedDefaultPages(int $tenantId, int $storefrontId): void
    {
        ...
        $brandName = $storefront !== null ? $storefront->name : 'Official Store';
        $storeSlug = $storefront !== null ? $storefront->subdomain : 'store';

        $defaultPages = $this->getDefaultPages($brandName, $storeSlug);
    ...
    /**
     * Get default preset pages and block configurations
     *
     * @return array<int, array<string, mixed>>
     */
    public function getDefaultPages(string $brandName, string $storeSlug): array
    {
        return [
            // 1. Flagship Homepage
            [
