...
final class StorefrontCustomizerController extends Controller
{
    ...
    public function updateSettings(Request $request): JsonResponse
    {
        ...
        $validated = $request->validate([
            ...
            'theme.footer_description' => 'nullable|string|max:1000',
            'theme.footer_show_whatsapp' => 'nullable|boolean',
            'theme.footer_whatsapp_label' => 'nullable|string|max:100',
            'theme.footer_show_payments' => 'nullable|boolean',
            'theme.footer_payment_methods' => 'nullable|array',
            'theme.footer_payment_methods.*' => 'nullable|string|max:64',
            'theme.footer_contact_title' => 'nullable|string|max:100',
            'theme.footer_address' => 'nullable|string|max:255',
            'theme.footer_phone' => 'nullable|string|max:50',
            'theme.footer_email' => 'nullable|string|max:100',
            'theme.footer_copyright' => 'nullable|string|max:255',
