...
const logistics = {
  ...
  subtitle: 'Courier integrations, waybills, rider dispatch & parcel tracking',
...
const finance = {
  ...
  subtitle: 'Chart of accounts, journal entries, trial balance & financial statements',
...
const hr = {
  ...
  subtitle: 'Workforce attendance, shifts, employee roster & monthly salary',
...
const assets = {
  title: 'Plant & Asset Registry',
  subtitle: 'Machinery tracking, maintenance schedules & depreciation',
...
const settings = {
  ...
  subtitle: 'Company profile, legal tax, warehouse branches & integrations',
